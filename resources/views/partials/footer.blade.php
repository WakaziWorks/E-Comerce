...
<footer class="bg-black text-center py-5">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h3 style="text-align: left; color: white;">Shopping Guide</h3>
                ...
                <div class="col">
                    <h3 style="text-align: left; color: white;">Customer Help</h3>
                ...
                <div class="col">
                    <h3 style="text-align: left; color: white;">Business</h3>
                ...
                <div class="col">
                    <h3 style="align-items: start; color: white;">Stay Connected</h3>
                    ...
                    <a href="https://twitter.com/wakaziworks" target="blank"><i class="bi bi-twitter"></i></a>
